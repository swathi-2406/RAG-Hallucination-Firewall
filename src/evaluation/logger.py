...
JSONL query log persistence for dashboard.
"""
...
def log_query(query, answer, firewall_result, eval_metrics, retrieval_latency_ms) -> dict:
    entry = {
        "timestamp": datetime.utcnow().isoformat(),
        "query": query,
        "answer": answer,
        "answer_backend": firewall_result.get("answer_backend", "unknown"),
